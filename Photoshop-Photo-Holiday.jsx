...
*/
{
    ...
    var btnPhotoFile = photoFileGroup.add("button", [0,0,100,22] , "Browse");
    btnPhotoFile.onClick = function(){selectPhotoFile()}; 
    lblPhotoPath = photoFileGroup.add("statictext", [0,0,120,22], "");
    var btnRenderPhoto = photoFileGroup.add("button", [0,0,120,30] , "Render");
    btnRenderPhoto.onClick = function(){renderPhotoHoliday()};  
    var btnClose = photoFileGroup.add("button", [0,0,120,30] , "Close");
    btnClose.onClick = function(){userPanel.close();};
